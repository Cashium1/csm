    ...
    options: [
      {
        ...
        scores: { "seo-blog": 3, "ai-service": 1 },
        reason: "혼자 집중하는 답변이 글쓰기 기반의 SEO·블로그 학습과 잘 맞습니다.",
      },
      {
        value: "social",
        label: "소통이 있는 편",
        description: "고객 응대, 제안, 운영처럼 사람과 연결되는 일이 괜찮습니다.",
        scores: { ecommerce: 2, affiliate: 2, reviewer: 2 },
        reason: "소통을 부담스럽게 느끼지 않아 이커머스·제휴·리뷰어 활동도 고려할 수 있습니다.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        scores: { "ai-service": 3, "seo-blog": 3, affiliate: 1 },
        reason: "콘텐츠 제작 관심이 높아 AI 서비스 제작과 블로그 수익화가 유리합니다.",
      },
      {
        value: "not-main",
        label: "주력은 아니에요",
        description: "콘텐츠보다 운영, 판매, 실행 쪽이 더 편합니다.",
        scores: { ecommerce: 2, reviewer: 2 },
        reason: "콘텐츠가 주력이 아니어도 이커머스나 리뷰어 활동으로 시작할 수 있습니다.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        scores: { ecommerce: 4, affiliate: 1 },
        reason: "상품과 운영에 관심이 있어 이커머스 적합도가 높습니다.",
      },
      {
        value: "no",
        label: "부담스러워요",
        description: "재고, CS, 배송보다 콘텐츠나 가벼운 활동이 편합니다.",
        scores: { "seo-blog": 2, reviewer: 2, "ai-service": 1 },
        reason: "재고와 운영 부담을 줄이는 블로그나 리뷰어 활동이 더 편할 수 있습니다.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        scores: { affiliate: 2, reviewer: 2, "ai-service": 1 },
        reason: "투입 시간이 적어 제휴 마케팅이나 리뷰어처럼 작게 검증하는 모델이 좋습니다.",
      },
      {
        value: "steady",
        label: "4~8시간",
        description: "주 2~3회 정도 꾸준히 시간을 낼 수 있습니다.",
        scores: { "seo-blog": 2, ecommerce: 2, affiliate: 2, reviewer: 2, "ai-service": 2 },
        reason: "꾸준한 시간이 있어 여러 카테고리를 비교하며 선택할 수 있습니다.",
      },
      {
        value: "deep",
        label: "9시간 이상",
        description: "학습과 실행을 함께 하며 깊게 실험할 수 있습니다.",
        scores: { ecommerce: 3, "ai-service": 3, "seo-blog": 2 },
        reason: "충분한 시간이 있어 이커머스나 AI 서비스 제작도 현실적으로 검토할 수 있습니다.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        scores: { affiliate: 3, reviewer: 3, "ai-service": 1 },
        reason: "작은 테스트를 선호해 제휴 마케팅이나 리뷰어 활동이 잘 맞습니다.",
      },
      {
        value: "structured",
        label: "구조를 잡고 천천히 해도 괜찮아요",
        description: "시간이 걸려도 누적되는 모델을 이해하고 싶습니다.",
        scores: { "seo-blog": 3, ecommerce: 2 },
        reason: "천천히 누적하는 방식이 블로그 수익화·이커머스와 어울립니다.",
      },
    ],
  },
  {
    id: "interest-area",
    title: "다음 중 어떤 활동에 가장 관심이 있나요?",
    options: [
      {
        value: "ai",
        label: "AI 툴 활용",
        description: "AI 도구로 콘텐츠나 작은 서비스를 만들어보고 싶습니다.",
        scores: { "ai-service": 5 },
        reason: "AI 도구 활용 관심이 AI 활용기반 서비스 제작과 직접 연결됩니다.",
      },
      {
        value: "writing",
        label: "글쓰기와 블로그",
        description: "블로그와 검색 글쓰기로 꾸준히 콘텐츠를 쌓고 싶습니다.",
        scores: { "seo-blog": 5 },
        reason: "글쓰기 관심이 SEO·블로그 수익화와 잘 맞습니다.",
      },
      {
        value: "marketing",
        label: "마케팅과 링크 수익",
        ...
        scores: { affiliate: 5 },
        reason: "전환과 링크 수익에 대한 관심이 제휴 마케팅과 어울립니다.",
      },
      {
        value: "selling",
        label: "상품 판매",
        ...
        scores: { ecommerce: 5 },
        reason: "상품 판매 관심이 분명해 이커머스를 먼저 볼 만합니다.",
      },
      {
        value: "review",
        label: "리뷰·체험단 활동",
        description: "제품을 체험하고 후기를 남기는 활동으로 가볍게 시작하고 싶습니다.",
        scores: { reviewer: 5 },
        reason: "체험·후기 활동에 대한 관심이 리뷰어 트랙과 잘 맞습니다.",
      },
    ],
  },
];
...
const primaryCourseByTrack: Record<TrackKey, string> = {
  reviewer: "reviewer-program",
  "ai-service": "instagram-reels-ai",
  affiliate: "affiliate-marketing",
  "seo-blog": "blog-monetization",
  ecommerce: "ecommerce-basic",
};
